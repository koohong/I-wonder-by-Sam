...
- W203 TEXT BOOK [LINK](https://www-cambridge-org.libproxy.berkeley.edu/core/books/foundations-of-agnostic-statistics/684756357E7E9B3DFF0A8157FB2DCECA)

- Install R/RStudio and LaTex [LINK](https://bookdown.org/yihui/rmarkdown-cookbook/install-latex.html)

- MIDS FOR LIFE [LINK](https://learn.berkeley.edu/courses/395)
...
$$\text{Proj}_{\vec{u}}{\vec{v}} = \frac{\vec{v}\cdot\vec{u}}{\vec{u}^T\vec{u}}\cdot\vec{u}$$
...
- Rank–nullity theorem [LINK](https://en.wikipedia.org/wiki/Rank%E2%80%93nullity_theorem#:~:text=The%20rank%E2%80%93nullity%20theorem%20is,the%20nullity%20of%20M%3B%20and)
...
- More on eignevalue, eigenvector, and Markov Chain
...
$$\mathbb{A}$$
$$\mathbb{A}: R^5 \rightarrow R^3$$

### Probability measure

- Similar notations (see page 5 and 6 of FOAS)
  - Sample Space, $\Omega$  (i.e.,coin H,T)
  - Event Space, $S$ (chance of getting H, chance of getting T, chance of getting H and T)
  - Probability Measure $P$

$$P: S \rightarrow \mathbb{R}$$ 
- $P$ is probability measure that assigns probability every event in event space. 
...
$$X: \text{{H,T}} \rightarrow \text{{0,1}} $$

### Other similar types

- Operator (example, $E[X]$)
  - Operator $E$ on random variable $X$, $E[X]$, maps entire sample space of X to a real number.
  
- Statistic $\bar{X}$
  - Maps sample to a number
  - Estimator (is this a random variable? yes, it is)
